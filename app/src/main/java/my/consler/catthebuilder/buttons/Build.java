...
public class Build implements View.OnClickListener
{
...
//        }
        ...
        {
            my.consler.catthebuilder.build.Build.start(context, app_name_input.getText().toString(), package_input.getText().toString(), version_input.getText().toString(), pickedFileName, action);
