...
public class BuildButton implements View.OnClickListener
{
    ...
    public void onClick(View view)
    {
        ...
        TextView action = activity.findViewById(R.id.action); // action is the little text that tells the user the stage the build is at
        ...
        String package_regex = "(?![0-9])([a-zA-Z_][a-zA-Z0-9_]*(\\.[a-zA-Z_][a-zA-Z0-9_]*)+)$"; // found this online, hope it works
        ...
        {
            Build.start(context, app_name_input.getText().toString(), package_input.getText().toString(), version_input.getText().toString(), version_code_input.getText().toString(), action, debug.isChecked(), round_icon_is_resizable.isChecked(), use_adaptive_icon.isChecked());
        }
    }
